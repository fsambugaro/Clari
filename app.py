...
# --- bloco 16: Seleção e exibição de Committed Deals ---
st.markdown('---')
...
# truncar Next Steps a 50 caracteres
...
# formata o Total New ASV em US e alinha à direita no grid
...
# exibe Committed Deals com estilo
