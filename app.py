...
# More Filters (translate others similarly)
...
try:
    ...
    st.warning('To enable chart downloads, install the "kaleido" package.')
...
# Grid and detail card setup
gb = GridOptionsBuilder.from_dataframe(disp)
bgb_default = gb.configure_default_column(cellStyle={'color':'white','backgroundColor':'#000000'})
