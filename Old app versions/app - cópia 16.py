...
# EDU / Others / All buttons
pre_edu_df = df.copy()
btn1, btn2, btn3 = st.sidebar.columns(3)
if btn1.button('EDU'):
    df = pre_edu_df[pre_edu_df['Sub Territory'].astype(str).str.contains('EDU', case=False, na=False)]
if btn2.button('Others'):
    df = pre_edu_df[~pre_edu_df['Sub Territory'].astype(str).str.contains('EDU', case=False, na=False)]
if btn3.button('All'):
    df = pre_edu_df

# 8) Totais atualizados após filtros
